...
const SUPPORTED_FORMATS = [
  ...
  const validateChange = e => {
    ...
    return (
        <div>
            <h1>Add new plant to yout list</h1>
  ...
  // https://www.youtube.com/watch?v=CgeWKZGjzzY
  // https://www.youtube.com/watch?v=yN5qKqLDlpM
  
  // Upload and display pictures: https://www.youtube.com/watch?v=XeiOnkEI7XI
  // https://medium.com/@650egor/react-30-day-challenge-day-2-image-upload-preview-2d534f8eaaa

  // https://www.pluralsight.com/guides/how-to-use-a-simple-form-submit-with-files-in-react
  // https://github.com/bradtraversy/meetupz/tree/master/client_src/src/components

  // Set new user : https://stackoverflow.com/questions/47941573/react-onclick-button-change-forms
  // Validate presence of a file: https://stackoverflow.com/questions/52427095/validating-file-presence-with-yup
